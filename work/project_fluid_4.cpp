    ...
    Tile<elem_t>& tile, Tile<elem_t>& prev_tile, Kernel<F>& kernel)
{
    ...
    bl_iter_t bl_begin = blocked_2d_view(inner, 128, 128).begin();
    bl_iter_t bl_end = blocked_2d_view(inner, 128, 128).end();
    bl_iter_t p_bl_begin =blocked_2d_view(p_inner, 128, 128).begin();
