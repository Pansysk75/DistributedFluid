...
auto gen_blocked_views(typename Tile<elem_t>::inner_2d_tile_t& in_view)
{
    ...
    size_t const block_size_x = 32;
    size_t const block_size_y = 32;
    ...
    Tile<elem_t>& tile, Tile<elem_t>& prev_tile, Kernel<F>& kernel)
{
    ...
    iter2_apply_par(views.begin(), views.end(), p_views.begin(),
...
#undef INTERP_PROPERTY
    ...
    auto k_make_some_fun =
        Kernel(1, 1, [&params](iter_2d_t const& prev, iter_2d_t& curr) -> void {
